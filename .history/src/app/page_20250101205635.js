...
export default function PreLaunchPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 pb-20 gap-16 sm:p-20 bg-gray-900 text-white font-[var(--font-geist-sans)]">
      {/* Hero Section */}
      <div className="flex flex-col items-center text-center gap-6 opacity-0 translate-y-12 animate-fadeInUp">
        <Image
          ...
          className="mb-4"
        />
        <h1 className="text-4xl font-bold sm:text-5xl animate-scaleIn">Coming Soon</h1>
      ...
      {/* Features Section */}
      <div className="flex flex-col gap-8 text-center mt-12 opacity-0 animate-fadeIn delay-500">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {[
            ...
            <div
              key={index}
              className="p-6 bg-gray-800 rounded-lg shadow-lg opacity-0 translate-y-6 animate-fadeInUp delay-200"
            >
      ...
      {/* Sign-Up Form */}
      <div className="flex flex-col items-center mt-12 w-full max-w-md opacity-0 scale-95 animate-fadeInUp delay-1000">
