      ...
      >
        ...
        >
          <div className="relative w-full">
            ...
            />
            {errors.email && (
              <span className="text-red-500 text-sm absolute mt-2">
          ...
          <Button
            type="submit"
            className="p-4 bg-white text-black rounded-lg font-semibold hover:bg-black hover:text-white transition duration-300 transform hover:scale-105"
          >
            Notify Me
          </Button>
        </form>
