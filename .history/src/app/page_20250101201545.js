...
export default function Home() {
  return (
    ...
    <div className="flex flex-col gap-8 text-center mt-12">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        <div className="p-6 bg-gray-800 rounded-lg shadow-lg">
          ...
          <p className="text-sm mt-2">Get connected with brands that align with your values and goals.</p>
        </div>
        <div className="p-6 bg-gray-800 rounded-lg shadow-lg">
          <h3 className="text-xl font-bold">Comprehensive E-Learning</h3>
          <p className="text-sm mt-2">Boost your marketing skills with tailored courses and resources.</p>
        </div>
        <div className="p-6 bg-gray-800 rounded-lg shadow-lg">
          <h3 className="text-xl font-bold">Personalized Profiles</h3>
          <p className="text-sm mt-2">Showcase your achievements and connect with potential collaborators.</p>
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-col items-center mt-12 w-full max-w-md">
      ...
      <p className="text-sm text-gray-400 mb-6">Sign up to be notified when we launch.</p>
