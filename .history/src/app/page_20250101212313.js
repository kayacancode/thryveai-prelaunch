...
export default function PreLaunchPage() {
  ...
  return (
    <div className="flex flex-col items-center bg-gradient-to-r from-blue-500 via-purple-600 to-indigo-800 justify-center min-h-screen p-8 pb-20 gap-24 sm:p-20 text-white font-[var(--font-geist-sans)]">
      {/* Hero Section */}
      <div
      ...
      >
        ...
        <p className="text-lg max-w-2xl sm:text-xl text-gray-200">
      ...
      >
        <form className="w-full flex items-center gap-4 relative">
          ...
          <button
            type="submit"
            className="absolute right-0 p-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-semibold hover:bg-blue-500 transition duration-300 transform hover:scale-105"
          >
            Notify Me
          </button>
        </form>
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">
          {[
            ...
            >
              ...
              <p className="text-sm mt-4 text-gray-400">{feature.description}</p>
            </div>
          ))}
        </div>
      </div>
