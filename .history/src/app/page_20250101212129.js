...
export default function PreLaunchPage() {
  ...
  <input
    ...
    className="p-4 rounded-lg text-black w-full border border-gray-300 bg-transparent focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
  />
  <button
    type="submit"
