...
export default function PreLaunchPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 pb-20 gap-16 sm:p-20 bg-gradient-to-r from-blue-900 to-purple-900 text-white font-[var(--font-geist-sans)]">
      {/* Hero Section */}
