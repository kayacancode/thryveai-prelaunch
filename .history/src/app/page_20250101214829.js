      ...
      >
        <form className="w-full flex items-center gap-4 relative">
          <input
            ...
            className="p-4 rounded-lg text-white w-full bg-transparent border-2  border-gray-600 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
          />
          <button
            type="submit"
