...
export default function PreLaunchPage() {
  ...
  const onSubmit = (data) => {
    ...
    console.log(data); // You can do further processing here like sending data to a server
  };
  ...
  return (
    <div className="flex flex-col items-center bg-gradient-to-r from-gray-800 via-gray-600 to-gray-500 animate-gradient-x justify-center min-h-screen p-8 pb-20 gap-24 sm:p-20 text-white font-[var(--font-geist-sans)]">
      ...
      <div
        ...
        data-aos-delay="400"
      >
        <form onSubmit={handleSubmit(onSubmit)} className="w-full flex items-center gap-4 relative">
          <input
            type="email"
