      ...
      >
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">
          {[
            ...
            <div
              key={index}
              className="p-8 bg-[#011A71] text-white rounded-xl shadow-xl transition-transform transform hover:scale-105 hover:shadow-2xl duration-300"
              data-aos="fade-up"
              data-aos-delay={index * 200 + 800}
            >
              <h3 className="text-2xl font-semibold">{feature.title}</h3>
              <p className="text-sm mt-4 text-white">{feature.description}</p>
            </div>
          ))}
        </div>
      </div>
