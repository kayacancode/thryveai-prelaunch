      ...
      >
        <form className="w-full flex items-center gap-4 relative">
          <input
            ...
            className="p-4 rounded-lg text-white w-full bg-transparent border border-gray-600 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
          />
          <button
            type="submit"
            className="absolute right-0 p-4 bg-white text-black rounded-lg font-semibold hover:bg-[#011A71] text-white transition duration-300 transform hover:scale-105"
          >
            Notify Me
          </button>
        </form>
