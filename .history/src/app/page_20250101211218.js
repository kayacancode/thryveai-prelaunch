...
export default function PreLaunchPage() {
  return (
    <div className="flex flex-col items-center bg-[#1D1D1D] justify-center min-h-screen p-8 pb-20 gap-16 sm:p-20 text-white font-[var(--font-geist-sans)]">
      {/* Hero Section */}
      <div className="flex flex-col items-center text-center gap-8">
        ...
        <form className="w-full flex flex-col gap-6">
          <input
            ...
            className="p-4 rounded-lg text-black w-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-bg-[#011A71] focus:border-transparent"
          />
          <button
            type="submit"
            className="p-4 bg-[#011A71] text-white rounded-lg font-semibold hover:bg-blue-500 transition duration-300 transform hover:scale-105"
          >
            Notify Me
          </button>
        </form>
