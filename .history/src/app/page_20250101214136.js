...
{/* Hero Section */}
    ...
    <h1 className="text-4xl font-extrabold sm:text-5xl tracking-tight overflow-hidden inline-block border-r-4 border-white pr-2 animate-typing animate-blink">
    Coming Soon
        </h1>
