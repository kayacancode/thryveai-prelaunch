    ...
    <div className="flex flex-col items-center bg-[#121212] justify-center min-h-screen p-8 pb-20 gap-24 sm:p-20 text-white font-[var(--font-geist-sans)]">
      ...
      >
        <form className="w-full flex items-center gap-4 relative">
          ...
          <button
            type="submit"
            className="absolute right-0 p-4 bg-white text-white rounded-lg font-semibold hover:bg-blue-500 transition duration-300 transform hover:scale-105"
          >
            Notify Me
          </button>
        </form>
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">
          {[
            ...
            <div
              key={index}
              className="p-8 bg-gray-800 rounded-xl shadow-md transition-transform transform hover:scale-105 hover:shadow-2xl duration-300"
              data-aos="fade-up"
